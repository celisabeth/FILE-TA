	...
	withImages({
		...
		env: {
			...
			NEXT_PUBLIC_SUPERSET_EMBED_AQE_OFF_PATH:
				process.env.NEXT_PUBLIC_SUPERSET_EMBED_AQE_OFF_PATH ||
				'/superset/welcome/?standalone=1',
			NEXT_PUBLIC_SUPERSET_EMBED_AQE_ON_PATH:
				process.env.NEXT_PUBLIC_SUPERSET_EMBED_AQE_ON_PATH || '/superset/welcome/?standalone=1',
			NEXT_PUBLIC_PROMETHEUS_URL: process.env.NEXT_PUBLIC_PROMETHEUS_URL || 'http://localhost:19090',
			NEXT_PUBLIC_PORTAL_PUBLIC_HOST:
				process.env.LHINSIGHT_PUBLIC_HOST || process.env.NEXT_PUBLIC_PORTAL_PUBLIC_HOST || '',
